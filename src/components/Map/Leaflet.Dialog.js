// This code was imported from https://github.com/NBTSolutions/Leaflet.Dialog
// For local changes only (mostly react fontawesome)
...
L.Control.Dialog = L.Control.extend({
  ...
  _initLayout: function() {
    ...
    var grabberIcon = L.DomUtil.create("i", "fas fa-arrows");
    ...
    var closeIcon = L.DomUtil.create("i", "fas fa-times");
    ...
    var resizeIcon = L.DomUtil.create("i", "fas fa-arrows-h fa-rotate-45");
...
L.control.dialog = function(options) {
  const ret = new L.Control.Dialog(options);
